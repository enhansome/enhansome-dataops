...
* [DataHub](https://github.com/linkedin/datahub) ⭐ 12,755 | 🐛 1,302 | 🌐 Python | 📅 2026-09-23 - LinkedIn's generalized metadata search & discovery tool.
* [CKAN](https://github.com/ckan/ckan) ⭐ 5,122 | 🐛 856 | 🌐 Python | 📅 2026-09-22 - Open-source DMS (data management system) for powering data hubs and data portals.
* [OpenLineage](https://github.com/OpenLineage/openlineage) ⭐ 2,672 | 🐛 373 | 🌐 Java | 📅 2026-09-23 - Open standard for metadata and lineage collection.
...
* [Marimo](https://github.com/marimo-team/marimo) ⭐ 22,881 | 🐛 602 | 🌐 Python | 📅 2026-09-23 - A reactive Python notebook that's reproducible, git-friendly, and deployable as scripts or apps.
* [Jupytext](https://github.com/mwouts/jupytext) ⭐ 7,251 | 🐛 166 | 🌐 Python | 📅 2026-09-22 - Jupyter Notebooks as Markdown Documents, Julia, Python or R scripts.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 33,800 | 🐛 582 | 🌐 Java | 📅 2026-09-23 - Open-source distributed event streaming platform used by thousands of companies.
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,337 | 🐛 1,748 | 🌐 Java | 📅 2026-09-23 - Distributed pub-sub messaging platform with a flexible messaging model and intuitive API.
...
* [Apache Airflow](https://github.com/apache/airflow) ⭐ 46,954 | 🐛 2,101 | 🌐 Python | 📅 2026-09-23 - A platform to programmatically author, schedule, and monitor workflows.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,197 | 🐛 2,569 | 🌐 Python | 📅 2026-09-23 - An orchestration platform for the development, production, and observation of data assets.
...
* [Apache Spark](https://github.com/apache/spark) ⭐ 44,030 | 🐛 582 | 🌐 Scala | 📅 2026-09-23 - A unified analytics engine for large-scale data processing.
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,359 | 🐛 378 | 🌐 Java | 📅 2026-09-23 - An open source stream processing framework with powerful capabilities.
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,670 | 🐛 3,960 | 🌐 Java | 📅 2026-09-23 - A unified model for defining both batch and streaming data-parallel processing pipelines.
...
* [Apache Nifi](https://github.com/apache/nifi) ⭐ 6,242 | 🐛 32 | 🌐 Java | 📅 2026-09-23 - An easy to use, powerful, and reliable system to process and distribute data.
...
* [Cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,671 | 🐛 124 | 🌐 Python | 📅 2026-01-13 - Data-centric AI tool to detect (non-predefined) issues in ML data like label errors or outliers.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 72,061 | 🐛 489 | 🌐 C++ | 📅 2026-09-23 - Language-neutral, platform-neutral, extensible mechanism for serializing structured data.
...
* [Apache Parquet](https://github.com/apache/parquet-mr) ⭐ 3,082 | 🐛 725 | 🌐 Java | 📅 2026-09-23 - A columnar storage format which provides efficient storage and encoding of data.
...
* [Apache Iceberg](https://github.com/apache/iceberg) ⭐ 9,266 | 🐛 915 | 🌐 Java | 📅 2026-09-23 - Open table format for huge analytic datasets.
* [Delta Lake](https://github.com/delta-io/delta) ⭐ 9,020 | 🐛 970 | 🌐 Scala | 📅 2026-09-23 - An open source project that enables building a Lakehouse architecture on top of data lakes.
* [Apache Hudi](https://github.com/apache/hudi) ⭐ 6,270 | 🐛 2,903 | 🌐 Java | 📅 2026-09-23 - Manages the storage of large analytical datasets on DFS.

## Data Visualization

*Tools for performing data visualization (DataViz).*

* [Apache Superset](https://github.com/apache/superset) ⭐ 74,899 | 🐛 570 | 🌐 Python | 📅 2026-09-23 - A modern data exploration and data visualization platform.
* [Dash](https://github.com/plotly/dash) ⭐ 24,426 | 🐛 421 | 🌐 Python | 📅 2026-09-23 - Analytical Web Apps for Python, R, Julia, and Jupyter.
...
* [Apache Hive](https://github.com/apache/hive) ⭐ 6,027 | 🐛 126 | 🌐 Java | 📅 2026-09-23 - Facilitates reading, writing, and managing large datasets residing in distributed storage.
...
* [Scylla](https://github.com/scylladb/scylla) ⭐ 15,772 | 🐛 3,698 | 🌐 C++ | 📅 2026-09-23 - Designed to be compatible with Cassandra while achieving higher throughputs and lower latencies.
* [Apache Druid](https://github.com/apache/druid) ⭐ 14,058 | 🐛 779 | 🌐 Java | 📅 2026-09-23 - Designed to quickly ingest massive quantities of event data, and provide low-latency queries.
* [Apache Cassandra](https://github.com/apache/cassandra) ⭐ 10,102 | 🐛 542 | 🌐 Java | 📅 2026-09-21 - Open source column based DBMS designed to handle large amounts of data.
* [Apache HBase](https://github.com/apache/hbase) ⭐ 5,560 | 🐛 411 | 🌐 Java | 📅 2026-09-23 - An open-source, distributed, versioned, column-oriented store.

### Document-Oriented Database

* [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,968 | 🐛 6,092 | 🌐 Java | 📅 2026-09-23 - A distributed document oriented database with a RESTful search engine.
* [MongoDB](https://github.com/mongodb/mongo) ⭐ 28,573 | 🐛 36 | 🌐 C++ | 📅 2026-09-23 - A cross-platform document database that uses JSON-like documents with optional schemas.
* [RethinkDB](https://github.com/rethinkdb/rethinkdb) ⭐ 27,000 | 🐛 1,352 | 🌐 C++ | 📅 2026-03-28 - The first open-source scalable database built for realtime applications.
* [Apache CouchDB](https://github.com/apache/couchdb) ⭐ 6,960 | 🐛 378 | 🌐 Erlang | 📅 2026-09-23 - An open-source document-oriented NoSQL database, implemented in Erlang.
...
* [ArangoDB](https://github.com/arangodb/arangodb) ⭐ 14,277 | 🐛 858 | 🌐 C++ | 📅 2026-09-23 - A scalable open-source multi-model database natively supporting graph, document and search.
* [JanusGraph](https://github.com/JanusGraph/janusgraph) ⭐ 5,841 | 🐛 590 | 🌐 Java | 📅 2026-09-23 - Manage large graphs with billions of data distributed across a multi-machine cluster.
...
* [Age](https://github.com/apache/age) ⭐ 4,851 | 🐛 254 | 🌐 C | 📅 2026-09-19 - A multi-model database that supports both graph and relational data models.
* [Memgraph](https://github.com/memgraph/memgraph) ⭐ 4,579 | 🐛 797 | 🌐 C++ | 📅 2026-09-23 - An open source graph database, built for real-time streaming data, compatible with Neo4j.

### Key-Value Database

* [Redis](https://github.com/redis/redis) ⭐ 76,453 | 🐛 2,975 | 🌐 C | 📅 2026-09-23 - An in-memory key-value database that persists on disk.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,304 | 🐛 351 | 🌐 Go | 📅 2026-09-23 - Distributed reliable key-value store for the most critical data of a distributed system.
* [Dragonfly](https://github.com/dragonflydb/dragonfly) ⭐ 31,668 | 🐛 306 | 🌐 C++ | 📅 2026-09-23 - A modern in-memory datastore, fully compatible with Redis and Memcached APIs.
* [Memcached](https://github.com/memcached/memcached) ⭐ 14,287 | 🐛 108 | 🌐 C | 📅 2026-09-11 - A high performance multithreaded event-based key/value cache store.
* [EVCache](https://github.com/Netflix/EVCache) ⭐ 2,223 | 🐛 22 | 🌐 Java | 📅 2026-09-16 - A distributed in-memory data store for the cloud.
* [Apache Accumulo](https://github.com/apache/accumulo) ⭐ 1,172 | 🐛 344 | 🌐 Java | 📅 2026-09-23 - A sorted, distributed key-value store that provides robust and scalable data storage.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach) ⭐ 32,487 | 🐛 8,344 | 🌐 Go | 📅 2026-09-23 - A distributed database designed to build, scale, and manage data-intensive apps.
* [PostgreSQL](https://github.com/postgres/postgres) ⭐ 22,182 | 🐛 0 | 🌐 C | 📅 2026-09-23 - An advanced RDBMS that supports an extended subset of the SQL standard.
* [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,761 | 🐛 74 | 🌐 Go | 📅 2026-09-22 - A lightweight, distributed relational database, which uses SQLite as its storage engine.
* [MySQL](https://github.com/mysql/mysql-server) ⭐ 12,435 | 🐛 71 | 🌐 C++ | 📅 2026-09-22 - One of the most popular open source transactional databases.
* [SQLite](https://github.com/sqlite/sqlite) ⭐ 10,535 | 🐛 23 | 🌐 C | 📅 2026-09-23 - A popular choice as embedded database software for local/client storage.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,268 | 🐛 526 | 🌐 C++ | 📅 2026-09-23 - A replacement of MySQL with more features, new storage engines and better performance.
* [Crate](https://github.com/crate/crate) ⭐ 4,437 | 🐛 327 | 🌐 Java | 📅 2026-09-23 - A distributed SQL database that makes it simple to store and analyze massive amounts of data.

### Time Series Database

* [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,754 | 🐛 2,183 | 🌐 Rust | 📅 2026-09-23 - Scalable datastore for metrics, events, and real-time analytics.
* [TimescaleDB](https://github.com/timescale/timescaledb) ⭐ 23,577 | 🐛 395 | 🌐 C | 📅 2026-09-23 - Open-source time-series SQL database optimized for fast ingest and complex queries.
* [QuestDB](https://github.com/questdb/questdb) ⭐ 17,342 | 🐛 966 | 🌐 Java | 📅 2026-09-23 - An open source SQL database designed to process time series data, faster.
...
* [Milvus](https://github.com/milvus-io/milvus/) ⭐ 46,240 | 🐛 1,434 | 🌐 Go | 📅 2026-09-23 - An open source embedding vector similarity search engine powered by Faiss, NMSLIB and Annoy.
* [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,762 | 🐛 742 | 🌐 Rust | 📅 2026-09-23 - An open source vector similarity search engine with extended filtering support.
...
* [Alluxio](https://github.com/Alluxio/alluxio) ⭐ 7,245 | 🐛 1,048 | 🌐 Java | 📅 2026-09-01 - A virtual distributed storage system.
* [LakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,541 | 🐛 446 | 🌐 Go | 📅 2026-09-23 - Open source tool that transforms your object storage into a Git-like repository.
* [GlusterFS](https://github.com/gluster/glusterfs) ⭐ 5,242 | 🐛 353 | 🌐 C | 📅 2026-09-23 - A software defined distributed storage that can scale to several petabytes.
...
* [SeaweedFS](https://github.com/chrislusf/seaweedfs) ⭐ 40 | 🐛 1 | 🌐 Go | 📅 2026-09-18 - A fast distributed storage system for blobs, objects, files, and data lake.
...
* [Grafana](https://github.com/grafana/grafana) ⭐ 76,867 | 🐛 3,302 | 🌐 TypeScript | 📅 2026-09-23 - Visualize metrics, logs, and traces from multiple sources like Prometheus, Loki, InfluxDB and more.
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 66,194 | 🐛 905 | 🌐 Go | 📅 2026-09-23 - A monitoring system and time series database.
* [Loki](https://github.com/grafana/loki) ⭐ 28,938 | 🐛 1,488 | 🌐 Go | 📅 2026-09-23 - A horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus.
...
* [Presto](https://github.com/prestodb/presto) ⭐ 16,745 | 🐛 2,981 | 🌐 Java | 📅 2026-09-23 - A distributed SQL query engine for big data.
* [Trino](https://github.com/trinodb/trino) ⭐ 13,270 | 🐛 2,766 | 🌐 Java | 📅 2026-09-23 - A fast distributed SQL query engine for big data analytics.
...
* [Apache Impala](https://github.com/apache/impala) ⭐ 1,287 | 🐛 8 | 🌐 C++ | 📅 2026-09-23 - Lightning-fast, distributed SQL queries for petabytes of data.
...
* [Awesome Data Engineering](https://github.com/igorbarinov/awesome-data-engineering) ⭐ 9,094 | 🐛 32 | 📅 2026-09-07
* [Awesome MLOps](https://github.com/kelvins/awesome-mlops) ⭐ 5,281 | 🐛 90 | 🌐 Python | 📅 2026-08-17
