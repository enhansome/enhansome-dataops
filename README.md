...
* [DataHub](https://github.com/linkedin/datahub) ⭐ 12,611 | 🐛 1,267 | 🌐 Python | 📅 2026-08-29 - LinkedIn's generalized metadata search & discovery tool.
...
* [Marimo](https://github.com/marimo-team/marimo) ⭐ 22,538 | 🐛 601 | 🌐 Python | 📅 2026-08-29 - A reactive Python notebook that's reproducible, git-friendly, and deployable as scripts or apps.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 33,640 | 🐛 525 | 🌐 Java | 📅 2026-08-29 - Open-source distributed event streaming platform used by thousands of companies.
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,317 | 🐛 1,731 | 🌐 Java | 📅 2026-08-28 - Distributed pub-sub messaging platform with a flexible messaging model and intuitive API.
...
* [Apache Airflow](https://github.com/apache/airflow) ⭐ 46,634 | 🐛 1,976 | 🌐 Python | 📅 2026-08-29 - A platform to programmatically author, schedule, and monitor workflows.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 16,073 | 🐛 2,586 | 🌐 Python | 📅 2026-08-28 - An orchestration platform for the development, production, and observation of data assets.
...
* [Apache Spark](https://github.com/apache/spark) ⭐ 43,899 | 🐛 502 | 🌐 Scala | 📅 2026-08-29 - A unified analytics engine for large-scale data processing.
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,302 | 🐛 371 | 🌐 Java | 📅 2026-08-28 - An open source stream processing framework with powerful capabilities.
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,653 | 🐛 3,956 | 🌐 Java | 📅 2026-08-29 - A unified model for defining both batch and streaming data-parallel processing pipelines.
...
* [Apache Nifi](https://github.com/apache/nifi) ⭐ 6,211 | 🐛 37 | 🌐 Java | 📅 2026-08-28 - An easy to use, powerful, and reliable system to process and distribute data.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,831 | 🐛 317 | 🌐 C++ | 📅 2026-08-29 - Language-neutral, platform-neutral, extensible mechanism for serializing structured data.
...
* [Apache Iceberg](https://github.com/apache/iceberg) ⭐ 9,183 | 🐛 904 | 🌐 Java | 📅 2026-08-29 - Open table format for huge analytic datasets.
* [Delta Lake](https://github.com/delta-io/delta) ⭐ 8,962 | 🐛 939 | 🌐 Scala | 📅 2026-08-29 - An open source project that enables building a Lakehouse architecture on top of data lakes.
* [Apache Hudi](https://github.com/apache/hudi) ⭐ 6,227 | 🐛 2,852 | 🌐 Java | 📅 2026-08-29 - Manages the storage of large analytical datasets on DFS.

## Data Visualization

*Tools for performing data visualization (DataViz).*

* [Apache Superset](https://github.com/apache/superset) ⭐ 74,533 | 🐛 603 | 🌐 Python | 📅 2026-08-29 - A modern data exploration and data visualization platform.
* [Dash](https://github.com/plotly/dash) ⭐ 24,390 | 🐛 534 | 🌐 Python | 📅 2026-08-28 - Analytical Web Apps for Python, R, Julia, and Jupyter.
...
* [Apache Hive](https://github.com/apache/hive) ⭐ 6,015 | 🐛 111 | 🌐 Java | 📅 2026-08-28 - Facilitates reading, writing, and managing large datasets residing in distributed storage.
...
* [Scylla](https://github.com/scylladb/scylla) ⭐ 15,725 | 🐛 3,634 | 🌐 C++ | 📅 2026-08-29 - Designed to be compatible with Cassandra while achieving higher throughputs and lower latencies.
* [Apache Druid](https://github.com/apache/druid) ⭐ 14,047 | 🐛 790 | 🌐 Java | 📅 2026-08-29 - Designed to quickly ingest massive quantities of event data, and provide low-latency queries.
* [Apache Cassandra](https://github.com/apache/cassandra) ⭐ 10,086 | 🐛 475 | 🌐 Java | 📅 2026-08-29 - Open source column based DBMS designed to handle large amounts of data.
...
* [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,876 | 🐛 6,006 | 🌐 Java | 📅 2026-08-29 - A distributed document oriented database with a RESTful search engine.
* [MongoDB](https://github.com/mongodb/mongo) ⭐ 28,513 | 🐛 32 | 🌐 C++ | 📅 2026-08-29 - A cross-platform document database that uses JSON-like documents with optional schemas.
...
* [Neo4j](https://github.com/neo4j/neo4j) ⭐ 17,162 | 🐛 247 | 🌐 Java | 📅 2026-08-24 - A high performance graph store with all the features expected of a mature and robust database.
* [ArangoDB](https://github.com/arangodb/arangodb) ⭐ 14,267 | 🐛 834 | 🌐 C++ | 📅 2026-08-29 - A scalable open-source multi-model database natively supporting graph, document and search.
...
* [Memgraph](https://github.com/memgraph/memgraph) ⭐ 4,375 | 🐛 805 | 🌐 C++ | 📅 2026-08-29 - An open source graph database, built for real-time streaming data, compatible with Neo4j.

### Key-Value Database

* [Redis](https://github.com/redis/redis) ⭐ 76,141 | 🐛 2,921 | 🌐 C | 📅 2026-08-28 - An in-memory key-value database that persists on disk.
...
* [Memcached](https://github.com/memcached/memcached) ⭐ 14,262 | 🐛 103 | 🌐 C | 📅 2026-07-10 - A high performance multithreaded event-based key/value cache store.
* [EVCache](https://github.com/Netflix/EVCache) ⭐ 2,209 | 🐛 21 | 🌐 Java | 📅 2026-08-11 - A distributed in-memory data store for the cloud.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach) ⭐ 32,430 | 🐛 8,453 | 🌐 Go | 📅 2026-08-26 - A distributed database designed to build, scale, and manage data-intensive apps.
* [PostgreSQL](https://github.com/postgres/postgres) ⭐ 21,934 | 🐛 0 | 🌐 C | 📅 2026-08-29 - An advanced RDBMS that supports an extended subset of the SQL standard.
* [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,712 | 🐛 82 | 🌐 Go | 📅 2026-08-29 - A lightweight, distributed relational database, which uses SQLite as its storage engine.
...
* [SQLite](https://github.com/sqlite/sqlite) ⭐ 10,365 | 🐛 23 | 🌐 C | 📅 2026-08-29 - A popular choice as embedded database software for local/client storage.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,152 | 🐛 476 | 🌐 C++ | 📅 2026-08-29 - A replacement of MySQL with more features, new storage engines and better performance.
...
* [TimescaleDB](https://github.com/timescale/timescaledb) ⭐ 23,440 | 🐛 398 | 🌐 C | 📅 2026-08-29 - Open-source time-series SQL database optimized for fast ingest and complex queries.
* [QuestDB](https://github.com/questdb/questdb) ⭐ 17,289 | 🐛 935 | 🌐 Java | 📅 2026-08-29 - An open source SQL database designed to process time series data, faster.
...
* [Milvus](https://github.com/milvus-io/milvus/) ⭐ 45,874 | 🐛 1,332 | 🌐 Go | 📅 2026-08-28 - An open source embedding vector similarity search engine powered by Faiss, NMSLIB and Annoy.
* [Qdrant](https://github.com/qdrant/qdrant) ⭐ 34,257 | 🐛 728 | 🌐 Rust | 📅 2026-08-29 - An open source vector similarity search engine with extended filtering support.
...
* [GlusterFS](https://github.com/gluster/glusterfs) ⭐ 5,221 | 🐛 286 | 🌐 C | 📅 2026-08-28 - A software defined distributed storage that can scale to several petabytes.
...
* [Grafana](https://github.com/grafana/grafana) ⭐ 76,478 | 🐛 3,324 | 🌐 TypeScript | 📅 2026-08-29 - Visualize metrics, logs, and traces from multiple sources like Prometheus, Loki, InfluxDB and more.
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,885 | 🐛 881 | 🌐 Go | 📅 2026-08-29 - A monitoring system and time series database.
* [Loki](https://github.com/grafana/loki) ⭐ 28,806 | 🐛 1,732 | 🌐 Go | 📅 2026-08-29 - A horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus.
...
* [Presto](https://github.com/prestodb/presto) ⭐ 16,725 | 🐛 2,948 | 🌐 Java | 📅 2026-08-29 - A distributed SQL query engine for big data.
* [Trino](https://github.com/trinodb/trino) ⭐ 13,194 | 🐛 2,724 | 🌐 Java | 📅 2026-08-28 - A fast distributed SQL query engine for big data analytics.
...
* [Awesome Data Engineering](https://github.com/igorbarinov/awesome-data-engineering) ⭐ 9,002 | 🐛 34 | 📅 2026-07-18
