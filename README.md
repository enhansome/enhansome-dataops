...
* [DataHub](https://github.com/linkedin/datahub) ⭐ 12,533 | 🐛 1,222 | 🌐 Python | 📅 2026-08-15 - LinkedIn's generalized metadata search & discovery tool.
* [CKAN](https://github.com/ckan/ckan) ⭐ 5,094 | 🐛 829 | 🌐 Python | 📅 2026-08-15 - Open-source DMS (data management system) for powering data hubs and data portals.
* [OpenLineage](https://github.com/OpenLineage/openlineage) ⭐ 2,602 | 🐛 341 | 🌐 Java | 📅 2026-08-15 - Open standard for metadata and lineage collection.
...
* [Marimo](https://github.com/marimo-team/marimo) ⭐ 22,335 | 🐛 582 | 🌐 Python | 📅 2026-08-15 - A reactive Python notebook that's reproducible, git-friendly, and deployable as scripts or apps.
...
* [Apache Kafka](https://github.com/apache/kafka) ⭐ 33,546 | 🐛 485 | 🌐 Java | 📅 2026-08-15 - Open-source distributed event streaming platform used by thousands of companies.
* [Apache Pulsar](https://github.com/apache/pulsar) ⭐ 15,310 | 🐛 1,706 | 🌐 Java | 📅 2026-08-15 - Distributed pub-sub messaging platform with a flexible messaging model and intuitive API.
...
* [Apache Airflow](https://github.com/apache/airflow) ⭐ 46,499 | 🐛 1,856 | 🌐 Python | 📅 2026-08-15 - A platform to programmatically author, schedule, and monitor workflows.
...
* [Dagster](https://github.com/dagster-io/dagster) ⭐ 15,996 | 🐛 2,598 | 🌐 Python | 📅 2026-08-14 - An orchestration platform for the development, production, and observation of data assets.
...
* [Apache Spark](https://github.com/apache/spark) ⭐ 43,820 | 🐛 446 | 🌐 Scala | 📅 2026-08-15 - A unified analytics engine for large-scale data processing.
* [Apache Flink](https://github.com/apache/flink) ⭐ 26,262 | 🐛 376 | 🌐 Java | 📅 2026-08-14 - An open source stream processing framework with powerful capabilities.
* [Apache Beam](https://github.com/apache/beam) ⭐ 8,642 | 🐛 3,987 | 🌐 Java | 📅 2026-08-15 - A unified model for defining both batch and streaming data-parallel processing pipelines.
...
* [Apache Storm](https://github.com/apache/storm) ⭐ 6,696 | 🐛 38 | 🌐 Java | 📅 2026-08-11 - An open source distributed realtime computation system.
* [Apache Nifi](https://github.com/apache/nifi) ⭐ 6,192 | 🐛 37 | 🌐 Java | 📅 2026-08-15 - An easy to use, powerful, and reliable system to process and distribute data.
...
* [Cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,627 | 🐛 117 | 🌐 Python | 📅 2026-01-13 - Data-centric AI tool to detect (non-predefined) issues in ML data like label errors or outliers.
...
* [ProtoBuf](https://github.com/protocolbuffers/protobuf) ⭐ 71,732 | 🐛 305 | 🌐 C++ | 📅 2026-08-15 - Language-neutral, platform-neutral, extensible mechanism for serializing structured data.
...
* [Snappy](https://github.com/google/snappy) ⭐ 6,598 | 🐛 62 | 🌐 C++ | 📅 2026-07-31 - Open source compression library that is fast, stable and robuts.
...
* [Apache Iceberg](https://github.com/apache/iceberg) ⭐ 9,138 | 🐛 901 | 🌐 Java | 📅 2026-08-15 - Open table format for huge analytic datasets.
...
* [Apache Hudi](https://github.com/apache/hudi) ⭐ 6,213 | 🐛 2,953 | 🌐 Java | 📅 2026-08-14 - Manages the storage of large analytical datasets on DFS.

## Data Visualization

*Tools for performing data visualization (DataViz).*

* [Apache Superset](https://github.com/apache/superset) ⭐ 74,268 | 🐛 584 | 🌐 Python | 📅 2026-08-15 - A modern data exploration and data visualization platform.
* [Dash](https://github.com/plotly/dash) ⭐ 24,377 | 🐛 538 | 🌐 Python | 📅 2026-08-13 - Analytical Web Apps for Python, R, Julia, and Jupyter.
...
* [Apache Hive](https://github.com/apache/hive) ⭐ 6,007 | 🐛 96 | 🌐 Java | 📅 2026-08-14 - Facilitates reading, writing, and managing large datasets residing in distributed storage.
...
* [Scylla](https://github.com/scylladb/scylla) ⭐ 15,708 | 🐛 3,559 | 🌐 C++ | 📅 2026-08-15 - Designed to be compatible with Cassandra while achieving higher throughputs and lower latencies.
* [Apache Druid](https://github.com/apache/druid) ⭐ 14,042 | 🐛 786 | 🌐 Java | 📅 2026-08-15 - Designed to quickly ingest massive quantities of event data, and provide low-latency queries.
* [Apache Cassandra](https://github.com/apache/cassandra) ⭐ 10,070 | 🐛 465 | 🌐 Java | 📅 2026-08-14 - Open source column based DBMS designed to handle large amounts of data.
* [Apache HBase](https://github.com/apache/hbase) ⭐ 5,556 | 🐛 369 | 🌐 Java | 📅 2026-08-14 - An open-source, distributed, versioned, column-oriented store.

### Document-Oriented Database

* [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,824 | 🐛 6,055 | 🌐 Java | 📅 2026-08-15 - A distributed document oriented database with a RESTful search engine.
...
* [Apache CouchDB](https://github.com/apache/couchdb) ⭐ 6,936 | 🐛 369 | 🌐 Erlang | 📅 2026-08-14 - An open-source document-oriented NoSQL database, implemented in Erlang.

### Graph Database

* [Neo4j](https://github.com/neo4j/neo4j) ⭐ 17,066 | 🐛 230 | 🌐 Java | 📅 2026-08-07 - A high performance graph store with all the features expected of a mature and robust database.
...
* [Age](https://github.com/apache/age) ⭐ 4,745 | 🐛 221 | 🌐 C | 📅 2026-08-15 - A multi-model database that supports both graph and relational data models.
* [Memgraph](https://github.com/memgraph/memgraph) ⭐ 4,337 | 🐛 801 | 🌐 C++ | 📅 2026-08-15 - An open source graph database, built for real-time streaming data, compatible with Neo4j.

### Key-Value Database

* [Redis](https://github.com/redis/redis) ⭐ 76,019 | 🐛 2,905 | 🌐 C | 📅 2026-08-13 - An in-memory key-value database that persists on disk.
* [etcd](https://github.com/etcd-io/etcd) ⭐ 52,125 | 🐛 309 | 🌐 Go | 📅 2026-08-15 - Distributed reliable key-value store for the most critical data of a distributed system.
* [Dragonfly](https://github.com/dragonflydb/dragonfly) ⭐ 30,997 | 🐛 306 | 🌐 C++ | 📅 2026-08-14 - A modern in-memory datastore, fully compatible with Redis and Memcached APIs.
...
* [CockroachDB](https://github.com/cockroachdb/cockroach) ⭐ 32,391 | 🐛 8,188 | 🌐 Go | 📅 2026-08-07 - A distributed database designed to build, scale, and manage data-intensive apps.
* [PostgreSQL](https://github.com/postgres/postgres) ⭐ 21,797 | 🐛 0 | 🌐 C | 📅 2026-08-15 - An advanced RDBMS that supports an extended subset of the SQL standard.
* [RQLite](https://github.com/rqlite/rqlite) ⭐ 17,683 | 🐛 80 | 🌐 Go | 📅 2026-08-10 - A lightweight, distributed relational database, which uses SQLite as its storage engine.
...
* [SQLite](https://github.com/sqlite/sqlite) ⭐ 10,270 | 🐛 22 | 🌐 C | 📅 2026-08-15 - A popular choice as embedded database software for local/client storage.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,103 | 🐛 454 | 🌐 C++ | 📅 2026-08-15 - A replacement of MySQL with more features, new storage engines and better performance.
* [Crate](https://github.com/crate/crate) ⭐ 4,417 | 🐛 330 | 🌐 Java | 📅 2026-08-15 - A distributed SQL database that makes it simple to store and analyze massive amounts of data.

### Time Series Database

* [InfluxDB](https://github.com/influxdata/influxdb) ⭐ 31,698 | 🐛 2,148 | 🌐 Rust | 📅 2026-08-14 - Scalable datastore for metrics, events, and real-time analytics.
* [TimescaleDB](https://github.com/timescale/timescaledb) ⭐ 23,333 | 🐛 383 | 🌐 C | 📅 2026-08-15 - Open-source time-series SQL database optimized for fast ingest and complex queries.
* [QuestDB](https://github.com/questdb/questdb) ⭐ 17,254 | 🐛 925 | 🌐 Java | 📅 2026-08-15 - An open source SQL database designed to process time series data, faster.
...
* [Milvus](https://github.com/milvus-io/milvus/) ⭐ 45,645 | 🐛 1,293 | 🌐 Go | 📅 2026-08-15 - An open source embedding vector similarity search engine powered by Faiss, NMSLIB and Annoy.
* [Qdrant](https://github.com/qdrant/qdrant) ⭐ 33,991 | 🐛 697 | 🌐 Rust | 📅 2026-08-15 - An open source vector similarity search engine with extended filtering support.
...
* [LakeFS](https://github.com/treeverse/lakeFS) ⭐ 5,486 | 🐛 438 | 🌐 Go | 📅 2026-08-05 - Open source tool that transforms your object storage into a Git-like repository.
* [GlusterFS](https://github.com/gluster/glusterfs) ⭐ 5,217 | 🐛 291 | 🌐 C | 📅 2026-02-16 - A software defined distributed storage that can scale to several petabytes.
* [Swift](https://github.com/openstack/swift) ⭐ 2,790 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - A distributed object storage system designed to scale from a single machine to thousands of servers.
...
* [Grafana](https://github.com/grafana/grafana) ⭐ 76,279 | 🐛 3,378 | 🌐 TypeScript | 📅 2026-08-15 - Visualize metrics, logs, and traces from multiple sources like Prometheus, Loki, InfluxDB and more.
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,709 | 🐛 887 | 🌐 Go | 📅 2026-08-15 - A monitoring system and time series database.
* [Loki](https://github.com/grafana/loki) ⭐ 28,739 | 🐛 1,764 | 🌐 Go | 📅 2026-08-15 - A horizontally-scalable, highly-available, multi-tenant log aggregation system inspired by Prometheus.
...
* [Trino](https://github.com/trinodb/trino) ⭐ 13,145 | 🐛 2,698 | 🌐 Java | 📅 2026-08-15 - A fast distributed SQL query engine for big data analytics.
...
* [Awesome Data Engineering](https://github.com/igorbarinov/awesome-data-engineering) ⭐ 8,952 | 🐛 26 | 📅 2026-07-18
* [Awesome MLOps](https://github.com/kelvins/awesome-mlops) ⭐ 5,240 | 🐛 73 | 🌐 Python | 📅 2026-04-29
